            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="md:col-span-2">
                <InputField
                  ...
                  required
                  placeholder="e.g. 1000 Wala Premium" helpText={undefined}                />
              </div>
              <div className="space-y-1">
                <label className="text-[11px] font-semibold text-[#6b778c] uppercase tracking-wide">
              ...
              <InputField
                ...
                value={product.mrp}
                onChange={handleChange}
                placeholder="0.00" helpText={undefined}              />
              <InputField
                label="Selling Price (₹)"
                name="price"
                type="number"
              ...
              <InputField
                ...
                type="number"
                value={product.piecesPerPacket}
                onChange={handleChange}
                placeholder="0"
                helpText="Number of pieces contained in one packet"
              />
              <InputField
                label="Sort Order"
                name="sortOrder"
          ...
          <div className="bg-white rounded-lg border border-[#dfe1e6] p-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <InputField
                ...
                onChange={handleChange}
                textarea
                placeholder="Key selling points, bundle details, or features" helpText={undefined}              />
              <InputField
                label="Safety Notes"
                name="safety"
                ...
                onChange={handleChange}
                textarea
                placeholder="Storage, handling, and usage safety notes" helpText={undefined}              />
              <div className="md:col-span-2">
                <InputField
                  ...
                  onChange={handleChange}
                  textarea
                  placeholder="Any extra notes for staff or customers" helpText={undefined}                />
              </div>
            </div>
          </div>
