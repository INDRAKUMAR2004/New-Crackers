          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-wrap items-center gap-3 text-sm mb-6">
              ...
              {Number(product.piecesPerPacket) > 0 && (
                <span className="bg-gray-50 border border-gray-100 px-2.5 py-1 rounded-lg text-slate-500 text-xs flex items-center gap-1.5">
                  <Package size={14} className="text-slate-500" />
                  <strong className="text-gray-900">{product.piecesPerPacket} Pieces / Packet</strong>
                </span>
              )}
